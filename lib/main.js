(function () {
   ...
   var tidl = {
                    ...
                    if (matches = stream.match(ID)) {
                        if (interface.Name != '') {
                            if (state.lastToken == 'k') {
                                ...
                                state.ec = '';
                                if (sname!=undefined){
                                    if (interface.Service.toLowerCase()!=sname.toLowerCase()){
                                        state.setError(2012);
                                        return 'error '+state.ec;
                                    }
                                }
                                else if (interface.Service.toUpperCase()[0] != interface.Service[0]) {
                        ...
                        if (sname!='' && interface.Name!='' && stream.peek() == '{'){
    ...
    if (this.CodeMirror||false) {
        ...
        sutil.StringStream = StringStream;
